...
public class FootstepSounds : MonoBehaviour
{
    ...
    public void AddFootstepAudioClip(AudioClip clip)
    {
        footstepSoundClips.Add(clip);
    }

    public void RemoveFootstepAudioClip(AudioClip clip)
    {
        footstepSoundClips.Remove(clip);
    }
}
